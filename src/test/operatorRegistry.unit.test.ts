...
describe('OperatorRegistry', () => {
  ...
  describe('isValidDataflowOperator', () => {
    ...
    it('accepts operators returning Stream<>', () => {
      ...
      expect(
        registry.isValidDataflowOperator('map', 'Stream<i32, Process<Leader>, Unbounded>')
      ).toBe(true);
      expect(registry.isValidDataflowOperator('filter', 'Stream<String, Cluster<Worker>>')).toBe(
        true
      );
    });
    ...
    it('accepts operators returning Singleton<>', () => {
      ...
      expect(registry.isValidDataflowOperator('fold', 'Singleton<i32, Process<Leader>>')).toBe(
        true
      );
    });
    ...
    it('accepts operators returning Optional<>', () => {
      ...
      expect(registry.isValidDataflowOperator('first', 'Optional<String, Process<Node>>')).toBe(
        true
      );
    });
    ...
    it('accepts operators returning KeyedStream<>', () => {
      ...
      expect(
        registry.isValidDataflowOperator('into_keyed', 'KeyedStream<String, i32, Process<Leader>>')
      ).toBe(true);
    });
